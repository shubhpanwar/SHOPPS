class ProductDetail {
    ...
    loadRecentlyViewedProducts() {
        ...
        const filteredRecentlyViewed = recentlyViewed.filter(id => id !== this.productId);
        
        // If no recently viewed products, hide the section
        if (filteredRecentlyViewed.length === 0) {
            const recentlyViewedSection = recentlyViewedContainer.closest('.recently-viewed-section');
        ...
        const recentProducts = filteredRecentlyViewed
        ...
        // Add event listeners
        this.addProductCardEventListeners(recentlyViewedContainer);
    }
}
